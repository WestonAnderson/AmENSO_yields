...
if SMcorr == 'T':
    ...
    fig = plt.figure();
    ax1=plt.subplot(122);ax2=plt.subplot(521);ax3=plt.subplot(523);ax4=plt.subplot(525);ax5=plt.subplot(427);
    ...
    ax3.set_xlim([0,12]);ax2.set_xlim([0,12]);
    ...
    ax5.set_ylabel('Safrinha cropping \ncycle Kc curve\n')
