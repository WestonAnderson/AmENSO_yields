...
crops = ['soy','maize','winterwheat']#,'springwheat']
yMin = -15; yMax = 15
notes = '_HAwgt'
PC = 'PC1'
PCsign = 1 #1 or -1
...
for crop in crops:
    ...
    fig = plt.figure()
    ax1 = plt.subplot(421); ax2 = plt.subplot(422)
    ax11 = plt.subplot(323);ax12 = plt.subplot(324);
    ax21 = plt.subplot(325);ax22 = plt.subplot(326);
    ax31 = plt.subplot(327);ax32 = plt.subplot(328);
    ...
    ax1.text(4,3.1,'LN -1',fontsize=12)#, fontweight='bold')
    ax1.text(16,3.1,'LN 0',fontsize=12)#, fontweight='bold')
    ax1.text(28,3.1,'LN +1',fontsize=12)#, fontweight='bold')
    ...
    ax2.text(4,3.1,'EN -1',fontsize=12)#, fontweight='bold')
    ax2.text(16,3.1,'EN 0',fontsize=12)#, fontweight='bold')
    ax2.text(28,3.1,'EN +1',fontsize=12)#, fontweight='bold')
